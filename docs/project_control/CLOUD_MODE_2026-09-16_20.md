...
**Rule ID:** RC-014  
**Status:** APPROVED / STRICTLY TEMPORARY / AUTO-EXPIRES AFTER 2026-09-20 / PREFLIGHT VERIFIED  
**Effective dates:** 2026-09-16 through 2026-09-20（含首尾两日）  
**Scope:** 仅《中国古建筑3D复原》项目，不适用于《诡舍·黑衣夫人》或其他项目。  
**Current baseline snapshot:** Project State R081 / 2026-09-15 Cloud workflow preflight state

## 0. 当前项目进入 Cloud Mode 前基线

截至 Project State `R081`：
...
若 2026-09-15 继续进行其他工作，本节必须在当天收尾后按最新 GitHub `main` 再刷新一次，作为最终 Pre-Cloud Snapshot。
...
- 2026-09-15 若继续进行其他工作，应在当天依据最新项目状态更新最终 Pre-Cloud Snapshot 与 pending-local list；
