...
|---|---|---|---|
| P0.0 | 项目控制系统可跨 Chat 使用 | **PASS** | Dashboard 可作为当前状态的可视化 handoff；正式事实现由 `docs/project_control/` 文件集保存。 |
...
| P0.3 | 建筑参数能够驱动脚本生成一个最小结构模型 | **UNLOCKED / NEXT** | 下一任务：T-004｜PARAMETRIC_ARCHITECTURE_POC_V001。 |
