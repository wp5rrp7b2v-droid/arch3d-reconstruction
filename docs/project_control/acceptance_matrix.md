...
| P1.1｜候选案例比较与定选 | 对 3–5 个候选对象按统一标准比较，并由 Product Owner 明确锁定一个正式案例 | **IN PROGRESS** | 当前候选池：平遥镇国寺万佛殿、五台佛光寺东大殿、五台南禅寺大殿、宁波保国寺大殿。必须使用 P1.0 锁定标准，不得因知名度或个人偏好改变权重。 |
...
P1.0 属于研究与项目判断，不创建 Codex T-###。P1.1 同样先由 ChatGPT 研究与 Product Owner 决策；只有出现实际工程执行任务时再创建 T 编号。
